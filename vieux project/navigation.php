...
<nav>
    <div style="background-color: lightgreen;">
        ...
        <ul class="nav nav-tabs justify-content-center" >
            ...
            <li class="nav-item">
                <a id="Question" class="nav-link" style = "color: white;font-size: 2em;" href="#">Upload</a>
            </li>
            <li class="nav-item">
                <a id="todo_list" class="nav-link" style = "color: white;font-size: 2em;" href="#">Write</a>
            </li>
            <li class="nav-item">
                <a id="Register" class="nav-link" style = "color: white;font-size: 2em;" href="Register.php">Register</a>
            </li>
            <li class="nav-item">
                <a id="Register" class="nav-link" style = "color: white;font-size: 2em;" href="#">Help</a>
            </li>
        </ul>
    </div>
</nav>
